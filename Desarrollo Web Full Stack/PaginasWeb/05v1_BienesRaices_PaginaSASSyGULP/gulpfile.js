...
// Correr SASS  || // parallel -> ejecutar n funciones al mismo tiempo

// Correr 
exports.dev = parallel(dev); 

// Correr por primera vez, optimizando imagenes
exports.devI = parallel(imagenesOP, versionAvif, versionWebp, dev);
